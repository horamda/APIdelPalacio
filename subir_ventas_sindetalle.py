...
def insert_data_in_batches(data, cursor, conn, batch_size=1000):
    ...
    INSERT INTO ventas_comprobantes (
        ...
        idCanalMkt, dsCanalMkt, idSubcanalMkt, fechaAsientoContable, 
    ...
    for venta in data['dsReporteComprobantesApi']['VentasResumen']:
        batch_values.append((
            ...
            venta['idArea'], venta['dsArea'], venta['idCanalMkt'], venta['dsCanalMkt'], venta['idSubcanalMkt'],
            venta['fechaAsientoContable'], venta['nroAsientoContable'], venta['nroPlanContable'], venta['codCuentaContable'],
            venta['idCentroCosto'], venta['dsCuentaContable'], venta['subtotalBruto'], venta['subtotalBonificado'],
            venta['subtotalNeto'], venta['iva21'], venta['iva27'], venta['iva105'], venta['per3337'], venta['iva2'],
            venta['percepcion212'], venta['percepcioniibb'], venta['internos'], venta['subtotalFinal'], venta['tradespendg'],
            venta['tradespends'], venta['tradespendb'], venta['tradespendi'], venta['tradespendp'], venta['tradespendt'],
            venta['totradspend'], venta['acciones'], venta['persiibbd'], venta['persiibbr'], venta['numerosserie'],
            venta['numerosactivo'], venta['cuentayorden'], venta['codprovcyo'], venta['descrip'], venta['nrorendcyo'],
            venta['idTipoCambio'], venta['dsTipoCambio'], venta['cfdiEmitido'], venta['regimenFiscal'], venta['informado'],
            venta['firmadigital'], venta['proveedor'], venta['fvigpcompra'], venta['preciocomprabr'], venta['preciocomprant'],
            venta['lineaCredito'], venta['numeracionFiscal'], venta['codproviibb']
        ))
...
try:
    ...
    if conn.is_connected():
        ...
        with open('C:/Users/horac/Desktop/api/json/ventassindetalle.json', 'r', encoding='utf-8') as file:
            data = json.load(file)
